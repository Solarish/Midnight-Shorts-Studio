...
export function LogoOutroInspector({ item, onParams, onItem }: LogoOutroInspectorProps) {
  ...
  return (
    <div className="inspector-container">
          ...
          <div className="inspector-card-body">
            <div className="inspector-field">
              ...
              <small style={{ color: "#94A3B8", fontSize: "11px" }}>
                UI จะปรับแต่งฟิลด์อัตโนมัติตาม Preset ที่เลือก
              </small>
            </div>
          </div>
        </details>
      ...
      {/* 2. AUTO UI: Mode A - PSU Golden Pulse Glow */}
      {presetId === "logo-outro-v1" && (
        <>
          ...
          <div className="inspector-card accent-gold">
            <details open>
              <summary style={{ color: "#E5A93C" }}>✍️ Outro Typography (3-Tier)</summary>
              <div className="inspector-card-body">
                <div className="inspector-field">
                  <label className="inspector-label">
          ...
          <div className="inspector-card accent-cyan">
            <details open>
              <summary style={{ color: "#22D3EE" }}>🎨 Glow Aura &amp; Scale</summary>
              <div className="inspector-card-body">
      ...
      {/* 3. AUTO UI: Mode B - Fullscreen Video Sting */}
      ...
      {/* 4. AUTO UI: Mode C - Modern Minimal Emblem */}
      ...
      {/* 5. Broadcast Audio Contract Badge */}
