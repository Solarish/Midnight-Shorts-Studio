...
const configSchemas: Record<string, JsonSchema> = {
  ...
  "timeline.graphic_overlay": object({ id: text("Graphic identifier"), graphic: json("Graphic output"), composition: text("Composition", { default: "Main" }), startMs: number("Start ms", { minimum: 0, default: 0 }), durationMs: number("Duration ms", { minimum: 40, maximum: 300000, default: 5000 }), track: number("Track", { minimum: 1, default: 3 }), audioPolicy: select("Audio policy", ["mute"]) }, ["id", "startMs", "durationMs", "track"]),
